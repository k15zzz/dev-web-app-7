...
use App\Repositories\TentRepository;
...
class SearchController extends Controller
{
     ...
     */
    public function searchProducer(AuthMiddleware $middleware, ProducerRequest $request, TentRepository $repository): string
    {
     ...
     * @throws ViewNotFoundException
     */
    public function searchCapacity(AuthMiddleware $middleware, CapacityRequest $request, TentRepository $repository): string
    {
